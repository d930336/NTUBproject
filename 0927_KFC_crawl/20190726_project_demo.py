...
main = html.find_all("div", style="cursor:pointer;text-align:center")
...
for _ in main:
    ...
    for i in index_main:
        # 設定資料夾路徑，怕標題有/
        dname = "C:/Users/case-pc/Desktop/crawl/" + Index_Title.split("/")[0] + "/"
...
df.to_excel("title_content.xlsx", encoding='utf-8', index=False)
df1.to_excel("title_address.xlsx", encoding='utf-8', index=False)